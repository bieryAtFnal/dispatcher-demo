/**
 * @file Packager.cpp Packager class
 * implementation
 *
 ...
 */
#define TRACE_NAME "Packager" // NOLINT
...
Packager::Packager(const std::string& name)
  : dunedaq::appfwk::DAQModule(name)
  , thread_(std::bind(&Packager::do_work, this, std::placeholders::_1))
  , outputQueues_()
  , queueTimeout_(100)
{
  register_command("configure", &Packager::do_configure);
  register_command("start",  &Packager::do_start);
  register_command("stop",  &Packager::do_stop);
  register_command("unconfigure",  &Packager::do_unconfigure);
}
...
void
Packager::do_configure(const std::vector<std::string>& /*args*/)
{
...
void
Packager::do_start(const std::vector<std::string>& /*args*/)
{
...
void
Packager::do_stop(const std::vector<std::string>& /*args*/)
{
...
void
Packager::do_unconfigure(const std::vector<std::string>& /*args*/)
{
...
void
Packager::do_work(std::atomic<bool>& running_flag)
{
...
DEFINE_DUNE_DAQ_MODULE(dunedaq::dispatcherdemo::Packager)
